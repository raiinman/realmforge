...
impl From<tavern_core::Account> for UserResponse {
    fn from(a: tavern_core::Account) -> Self {
...
) -> Result<tavern_core::Account, AccountError> {
...
pub async fn put_address(
    ...
    tavern_db::accounts::update(&state.pool, &account).await?;
    Ok(StatusCode::OK)
}
