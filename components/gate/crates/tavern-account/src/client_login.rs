...
pub async fn post_client_login(
    ...
    // login_ticket (tavern-interop-analysis.md §4.11a).
...
/// Shape per tavern-interop-analysis.md §4.11a (binary-verified).
...
async fn done_response(
    ...
    // The RE doc (tavern-interop-analysis §2.2) confirms the value is opaque
...
/// to the LEGAL `next_url` (tavern-interop-analysis.md §4.11a step 3); the
...
pub async fn get_agreement(
    ...
    let text = format!(
        "WoW Emulation Tavern — Terms of Service (version {version})\n\n\
