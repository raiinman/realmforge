...
//! Database pool, migrations, and repositories for Realmforge.
//!
...
/// Errors returned by `realmforge-gate-db`.
#[derive(Debug, Error)]
pub enum DbError {
...
/// to 8 (the legacy Realmforge value). All fields are configurable via environment
/// variables; see `realmforge_gate_core::Config`.
#[derive(Debug, Clone)]
