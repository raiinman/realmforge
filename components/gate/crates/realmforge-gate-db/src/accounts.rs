...
//! transaction, and return [`realmforge_gate_core::Account`] domain types.

use chrono::{DateTime, Utc};
use realmforge_gate_core::Account;
use sqlx::Executor;
...
/// row type from the domain keeps `realmforge-gate-core` free of any `sqlx` dependency.
#[derive(sqlx::FromRow)]
struct AccountRow {
    id: i64,
    email: String,
