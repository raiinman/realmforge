...
//!
//! A thin layer over the `jsonwebtoken` crate (no hand-rolled RSA). Realmforge
...
/// Signing algorithm. Realmforge uses RS256 only, matching the captured
...
/// Realmforge access-token / ID-token claims.
///
