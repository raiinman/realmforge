...
pub async fn dashboard(
    ...
    if let Some(ticket) = query
        .get("ticket")
        .and_then(|t| realmforge_gate_core::encrypted_ticket::open(t, &state.signing_key_pem).ok())
    {
        let _ = sqlx::query!(
...
<head>
  ...
  <title>Device Authorization - Realmforge</title>
...
<body class="page-center">
  <div class="card" style="text-align:center">
    <div style="margin-bottom: var(--space-md)">
      <img class="logo-mark logo-on-light" src="/static/realmforge-logo-light.png"
           width="64" height="64" alt="Realmforge" />
      <img class="logo-mark logo-on-dark" src="/static/realmforge-logo-dark.png"
           width="64" height="64" alt="Realmforge" />
    </div>
