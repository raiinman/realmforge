...
impl fmt::Display for GateError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::InvalidLoginName => write!(f, "login name is invalid"),
            Self::InvalidPassword => write!(f, "password does not meet Realmforge policy"),
            Self::InvalidPasswordHash => write!(f, "stored password hash is invalid"),
            Self::PasswordHashingFailed => write!(f, "password hashing failed"),
            Self::DuplicateLoginName => write!(f, "login name already exists"),
            Self::InvalidCredentials => write!(f, "credentials are invalid"),
